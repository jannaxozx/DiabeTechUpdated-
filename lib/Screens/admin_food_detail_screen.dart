...
class AdminFoodDetailScreen extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      ...
                      style: TextStyle(color: _grey3, fontSize: 12),
                    ),
  ...
  Widget _summaryRow(String label, String value) => Row(
    ...
    children: [
      Text(label, style: const TextStyle(fontSize: 12, color: _grey2)),
      Text(
        value,
        style: const TextStyle(
          fontSize: 13,
  ...
  Widget _macroLegend(String label, double val, Color color) => Column(
    children: [
      Row(
        mainAxisSize: MainAxisSize.min,
        children: [
