      ...
      builder: (context, snap) {
        ...
        final docs =
            (snap.data?.docs ?? []).where((doc) {
                final ts =
                    ((doc.data() as Map)['timestamp'] as Timestamp?)?.toDate();
                return ts != null &&
                    !ts.isBefore(today) &&
        ...
        for (final doc in docs) {
          final n =
              (doc.data() as Map)['nutrition'] as Map<String, dynamic>? ?? {};
          tCal += _d(n['calories']);
          tCarbs += _d(n['carbs']);
          tProt += _d(n['protein']);
          tFat += _d(n['fat']);
      ...
      Container(
        ...
        child: Column(
          children: [
            ...
            Text(label, style: const TextStyle(fontSize: 9, color: _ml_grey3)),
          ],
        ),
      );
  ...
  Widget _emptyState() => Center(
    child: Column(
      ...
      children: [
        ...
        Text(
          'Tap + Add Food to log your $mealType',
...
class _FoodLogCard extends StatelessWidget {
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          if (_d(n['calories']) > 0)
                            _chip(
                              '🔥 ${_d(n['calories']).toStringAsFixed(0)} kcal',
                              _ml_amber,
                              _ml_amberPal,
                            ),
                          if (_d(n['carbs']) > 0)
                            _chip(
                              '🍞 ${_d(n['carbs']).toStringAsFixed(1)}g',
                              _ml_blue,
                              _ml_bluePal,
                            ),
                          if (_d(n['protein']) > 0)
                            _chip(
                              '💪 ${_d(n['protein']).toStringAsFixed(1)}g',
                              _ml_purp,
                              _ml_purpPal,
                            ),
                          if (_d(n['fat']) > 0)
                            _chip(
                              '🧈 ${_d(n['fat']).toStringAsFixed(1)}g',
                              _ml_red,
                              _ml_redPal,
                            ),
                        ],
  ...
  Widget _imgPlaceholder() => Container(
    ...
    child: const Icon(Icons.fastfood_rounded, color: _ml_green, size: 26),
  );
          ...
          (ctx) => AlertDialog(
            ...
            title: const Row(
              children: [
                ...
                SizedBox(width: 8),
                Text('Remove Food', style: TextStyle(color: _ml_grey1)),
              ],
            ),
            content: Text(
            ...
            actions: [
              TextButton(
                ...
                child: const Text('Cancel', style: TextStyle(color: _ml_grey3)),
              ),
              ElevatedButton(
...
class _AddFoodSheetState extends State<AddFoodSheet> {
  ...
  Future<void> _saveToMealLog() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to save: $e'), backgroundColor: _ml_red),
      );
    }
  }
                  ...
                  children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: AnimatedContainer(
                                          ...
                                          decoration: BoxDecoration(
                                            color: sel ? _ml_green : _ml_grey5,
                                            borderRadius: BorderRadius.circular(
                                              12,
                                            ),
                                            border: Border.all(
                                              color:
                                                  sel ? _ml_green : _ml_grey4,
                                            ),
                                          ),
                                          child: Column(
                                            children: [
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        style: const TextStyle(color: _ml_grey1, fontSize: 14),
                        decoration: InputDecoration(
                          ...
                          border: OutlineInputBorder(
                            ...
                            borderSide: const BorderSide(color: _ml_grey4),
                          ),
                    ...
                    Expanded(
                      child:
                          _searchQuery.isEmpty && _selectedFood == null
                              ? _buildHint()
                              : _FoodSearchResults(
                                query: _searchQuery,
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                _selectedFood != null ? _ml_green : _ml_grey4,
    ...
    child: Column(
      ...
      children: [
        Container(
          ...
          child: const Icon(Icons.search_rounded, size: 40, color: _ml_green),
        ),
        const SizedBox(height: 14),
        const Text(
          'Search for a food',
...
class _SelectedFoodPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.check_circle_rounded, color: _ml_green, size: 20),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: result.isPersonalized ? _ml_tealPal : _ml_grey5,
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                      color:
                    ...
                    children: [
                      Icon(
                        result.isPersonalized
                            ...
                            : Icons.scale_rounded,
                        size: 9,
                        color: result.isPersonalized ? _ml_teal : _ml_grey3,
                      ),
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.w700,
                          color: result.isPersonalized ? _ml_teal : _ml_grey2,
                        ),
                      ),
                    ],
                  ),
          ...
          IconButton(
            icon: const Icon(Icons.close_rounded, size: 17, color: _ml_grey3),
            onPressed: onClear,
          ),
        ],
      ),
...
class _FoodSearchResults extends StatelessWidget {
      ...
      builder: (context, snap) {
        ...
        final filtered =
            query.isEmpty
                ...
                : typeFiltered.where((doc) {
                  ...
                  final kws =
                      (d['searchKeywords'] as List?)
                          ?.map((e) => e.toString())
                          .toList() ??
                      [];
                  return n.contains(query) || kws.any((k) => k.contains(query));
                }).toList();
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(color: _ml_grey3, fontSize: 12),
                ),
                const SizedBox(height: 14),
                Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: _ml_amberPal,
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(color: _ml_amber.withOpacity(0.3)),
                  ),
                  child: Row(
                    children: [
                      const Icon(
                      ...
                      const Expanded(
                        child: Text(
                          ...
                          style: TextStyle(fontSize: 11, color: _ml_grey2),
                        ),
                      ),
                    ],
                  ),
        ...
        return ListView.builder(
          ...
          itemBuilder: (ctx, i) {
            ...
            // BACKWARD COMPATIBLE: Check category from both old and new structure
            bool isSafe = false;
            final categories =
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isSel ? _ml_greenPal : _ml_white,
                  borderRadius: BorderRadius.circular(14),
                  border: Border.all(
                                ...
                                Expanded(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      fontWeight: FontWeight.w700,
                                      fontSize: 13,
                                      color: isSel ? _ml_green : _ml_grey1,
                                    ),
                                  ),
                                ),
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isSafe ? _ml_greenPal : _ml_redPal,
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                                  child: Text(
                                    isSafe ? '✅ Safe' : '⚠️ Avoid',
                                    style: TextStyle(
                                      fontSize: 9,
                                      color: isSafe ? _ml_green : _ml_red,
                                      fontWeight: FontWeight.w700,
                                    ),
                                  ),
                                ),
  ...
  Widget _imgPh() => Container(
    ...
    child: const Icon(Icons.fastfood_rounded, color: _ml_green, size: 24),
  );
